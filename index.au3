...
Global $gui_mainWindow = GUICreate("" & $guiTitle & "", 616, 340, -1, -1)
Global $gui_tabs = GUICtrlCreateTab(8, 0, 601, 289)
Global $gui_bedrockToJavaTab = GUICtrlCreateTabItem("Bedrock to Java")
GUICtrlSetTip(-1, "")
Global $gui_jeDescTitle = GUICtrlCreateLabel("Pack Description:", 15, 72, 88, 17)
Global $gui_jeNameInput = GUICtrlCreateInput("Pack name here", 88, 40, 513, 21)
GUICtrlSetTip(-1, "Pack name")
Global $gui_jeDescInput = GUICtrlCreateInput("Pack description here", 112, 72, 489, 21)
GUICtrlSetTip(-1, "Pack description")
Global $gui_beLoadInfo = GUICtrlCreateButton("Load original pack info", 13, 114, 145, 25)
GUICtrlSetTip(-1, "Load original pack name and description")
Global $gui_startBeToJeBtn = GUICtrlCreateButton("Start conversion", 457, 114, 145, 25)
GUICtrlSetTip(-1, "Start conversion")
Global $gui_jeNameTitle = GUICtrlCreateLabel("Pack Name:", 16, 40, 63, 17)
Global $gui_javaToBedrockTab = GUICtrlCreateTabItem("Java to Bedrock")
Global $gui_bePackNameInput = GUICtrlCreateInput("Pack name here", 88, 40, 513, 21)
GUICtrlSetTip(-1, "Pack name")
Global $gui_bePackDescInput = GUICtrlCreateInput("Pack description here", 112, 72, 489, 21)
GUICtrlSetTip(-1, "Pack description")
Global $gui_jeLoadInfo = GUICtrlCreateButton("Load original pack info", 13, 114, 145, 25)
GUICtrlSetTip(-1, "Load original pack name and description")
Global $gui_beDescTitle = GUICtrlCreateLabel("Pack Description:", 15, 72, 88, 17)
Global $gui_startJeToBeBtn = GUICtrlCreateButton("Start conversion", 457, 114, 145, 25)
GUICtrlSetTip(-1, "Start conversion")
Global $gui_beNameTitle = GUICtrlCreateLabel("Pack Name:", 16, 40, 63, 17)
...
Global $gui_bedrockSettingsGroup = GUICtrlCreateGroup("Bedrock Output Settings", 312, 160, 290, 81)
Global $gui_packMinVerTitle = GUICtrlCreateLabel("Minimuim Minecraft Version:", 320, 184, 135, 17)
Global $gui_packMinVerInput = GUICtrlCreateInput("", 464, 184, 121, 21)
Global $gui_OutputAsMcpackBox = GUICtrlCreateCheckbox("Output as .mcpack", 320, 208, 177, 17)
GUICtrlCreateGroup("", -99, -99, 1, 1)
Global $gui_javaSettingsGroup = GUICtrlCreateGroup("Java Output Settings", 16, 160, 290, 81)
Global $gui_packFormatTitle = GUICtrlCreateLabel("Pack Format version:", 24, 184, 104, 17)
Global $gui_outputAsZipBox = GUICtrlCreateCheckbox("Output as .zip", 24, 208, 121, 17)
Global $gui_packFormatInput = GUICtrlCreateInput("", 136, 184, 161, 21)
GUICtrlCreateGroup("", -99, -99, 1, 1)
...
GUICtrlSetCursor (-1, 0)
Global $gui_github = GUICtrlCreateLabel("View source code,  report bugs and contribute on GitHub", 235, 320, 273, 17)
